public class Message {
    ...
    public static final String KEY_ENCRYPTION = "Введите ключ шифрования, ключ не должен превышать значение 999999999:";
    public static final String KEY_ERROR = "Вы ввели не число в поле ключа или неправильное значение, попробуйте все заново";
    ...
    public static final String DEFAULT = "Выбран язык по умолчанию \"Русский\" т.к. указанного словаря не существует";
